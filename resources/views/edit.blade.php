<x-app-layout>
<header class="mt-10">
      <h1 class="text-2xl text-center text-gray-800 font-bold">Edit Task</h1>
    </header>
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
            <form method="POST" action="/task/{{ $task->id }}">
                ...
                <div class="mt-4">
                <input type="checkbox" id="due_date_checkbox" name="due_date_checkbox" {{ $task->due_date_checkbox ? 'checked' : '' }}>
<label for="due_date_checkbox" class="inline-block">Do you have a date this should be completed by?</label>
                        ...
                        <div id="due_date_picker" class="mt-2 hidden">
                            ...
                            <input value="{{$task->due_date}}" type="date" id="due_date" name="due_date"
