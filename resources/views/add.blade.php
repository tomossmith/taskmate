<x-app-layout>
    <x-slot name="header">
        <h2 class="text-center font-semibold text-xl text-gray-800 leading-tight">{{ __('Add Task') }}</h2>
    </x-slot>
                ...
                <form method="POST" action="/task">
                    <div class="form-group">
                        ...
                        <div class="mt-4">
                            ...
                            <label class="inline-block">Do you have a date this should be completed by?</label>
                        </div>
